...
class ControllerUserUserPermission extends Controller {
	...
	public function index() {
		...
		$this->document->setTitle('Grupos de usuarios');
	...
	public function add() {
		...
		$this->document->setTitle('Agregar grupo de usuarios');
	...
	public function edit() {
		...
		$this->document->setTitle('Editar grupo de usuarios');
	...
	public function delete() {
		...
		$this->document->setTitle('Eliminar grupo de usuarios');
	...
	protected function getList() {
		...
		$data['results'] = sprintf('Mostrando % d a % d de % d (% d P&aacute;ginas)', ($user_group_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($user_group_total - $this->config->get('config_limit_admin'))) ? $user_group_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $user_group_total, ceil($user_group_total / $this->config->get('config_limit_admin')));
	...
	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'user/user_permission')) {
			$this->error['warning'] = 'Error, no tienenes permisos para modificar este módulo';
		}

		if ((utf8_strlen($this->request->post['name']) < 3) || (utf8_strlen($this->request->post['name']) > 64)) {
			$this->error['name'] = 'Error, el nombre no es válido';
		}
